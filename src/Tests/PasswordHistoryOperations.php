...
/**
 * @file
 * Definition of Drupal\password_policy_history\Tests\PasswordHistoryOperations.
 */
...
/**
 * Tests password history operations.
 *
 * @group password_policy_history
 */
class PasswordHistoryOperations extends WebTestBase {
